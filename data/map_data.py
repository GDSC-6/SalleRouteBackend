map_data = {
    "floorPlan": {
        "url": "public/H8HallBuildingEditedX2.svg",
        "width": 800,
        "height": 600
    },
    "rooms": [
    ...
    "edges": [
        {"source": "start", "target": "837", "weight": 10},
        {"source": "start", "target": "835", "weight": 10},
        {"source": "start", "target": "833", "weight": 10},
        {"source": "837", "target": "831", "weight": 10}
    ]
}